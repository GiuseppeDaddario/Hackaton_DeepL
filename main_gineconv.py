...
from source.models import GNN, GINENetWithTransformer, newModel
...
def main(args, full_train_dataset_outer=None, train_loader_outer=None, val_loader_outer=None):
    ...
    if args.gnn_type == 'gine':
        ...
        logging.info(f"• Model architecture      : GINENetWithTransformer ({args.gnn_type})")
    ...
    if args.train_path:
        ...
        if val_dataset_subset:
            ...
            logging.info(f"• Validation set          : 0 campioni\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gnn_type', type=str, default='gine', choices=['transformer','gine', 'newModel']) # Modificato qui
    ...
    parser.add_argument('--jk', type=str, default="last", choices=["last","concat","sum","max"])
    parser.add_argument('--jk_mode', type=str, default="last") # Per GNN
    parser.add_argument('--graph_pooling', type=str, default="add", choices=["sum", "mean", "max", "add"])
